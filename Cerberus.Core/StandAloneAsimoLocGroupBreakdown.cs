...
{
    /// <summary>
    /// Wrapper object around OSLEBot that works without database and creates one instance of OSLEBot engine per each locgroup.
    /// </summary>
    public class StandAloneAsimoLocGroupBreakdown : StandaloneAsimo
    {
        /// <summary>
