...
namespace Microsoft.Localization.LocSolutions.Cerberus.Executor
{
    ...
    public class CerberusConsoleLogger : ILogger
    {
        ...
        {
            foreach (var replacer in _osleBotOutputReplacers)
            {
        ...
        {
            return _osleBotFilters.Any(filter => filter.IsMatch(entry));
        }

        /// <summary>
        /// Filters that modify output lines matching the specified patterns to make them easier to read by humans.
        /// </summary>
        private readonly List<ConsoleStringReplacer> _osleBotOutputReplacers;
        /// <summary>
        /// Filters that suppress lines of output with specified patterns.
        /// </summary>
        private readonly List<Regex> _osleBotFilters;
        /// <summary>
        ...
        {
            _osleBotFilters = new List<Regex>
                                  {
            ...
            _osleBotOutputReplacers = new List<ConsoleStringReplacer>
                                          {
