...
namespace Microsoft.Localization.LocSolutions.Cerberus.Configurator
{
    ...
    public static class UIExtensions
    {
        ...
        /// <summary>
        /// Invokes the specified piece of code on the UI thread that owns this UI element.
        /// <para/>It is done without blocking the current thread. This is achieved by using ThreadPool thread.
        /// </summary>
        /// <param name="me">DispatcherObject that has a dispatcher.</param>
        /// <param name="method">Piece of code to be executed on UI thread.</param>
        public static void InvokeAsynchronouslyOnUIThread(this DispatcherObject me, MethodInvoker method)
        {
            ThreadPool.QueueUserWorkItem((x) => me.Dispatcher.Invoke(method));
        }
